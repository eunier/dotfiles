...
echo "# sh ~/.dotfiles/src/diff/diff-dconf.s"
...
sh ~/.dotfiles/src/diff/diff-dnf-copr-list.sh
sh ~/.dotfiles/src/diff/diff-dnf-info-installed.sh
sh ~/.dotfiles/src/diff/diff-dnf-repo-list.sh
