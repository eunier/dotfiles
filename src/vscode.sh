...
code --install-extension bierner.markdown-mermaid >/dev/null 2>&1 && printf "."
code --install-extension bpruitt-goddard.mermaid-markdown-syntax-highlighting >/dev/null 2>&1 && printf "."
...
code --install-extension GitHub.github-vscode-theme >/dev/null 2>&1 && printf "."
code --install-extension Gruntfuggly.todo-tree >/dev/null 2>&1 && printf "."
code --install-extension hossaini.bootstrap-intellisense >/dev/null 2>&1 && printf "."
...
code --install-extension inferrinizzard.prettier-sql-vscode >/dev/null 2>&1 && printf "."
...
code --install-extension mani-sh-reddy.atom-one-light-modern >/dev/null 2>&1 && printf "."
...
code --install-extension ms-dotnettools.blazorwasm-companion >/dev/null 2>&1 && printf "."
code --install-extension ms-vscode.cpptools-extension-pack >/dev/null 2>&1 && printf "."
code --install-extension olifink.fedora-gnome-light-dark >/dev/null 2>&1 && printf "."
...
code --install-extension ritwickdey.LiveServer >/dev/null 2>&1 && printf "."
