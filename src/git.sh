...
[ $? -eq 128 ] && printf "."
git clone git@gitlab.com:yunieralvarez/playground.git ~/Projects/com.gitlab.yunieralvarez.playground/playground.git >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone git@gitlab.com:yunieralvarez/qmkl.git ~/Projects/com.gitlab.yunieralvarez.qmkl/qmkl >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone git@gitlab.com:yunieralvarez/repo-resources.git ~/Projects/com.gitlab.yunieralvarez.repo-resources/repo-resources >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
...
[ $? -eq 128 ] && printf "."
git clone https://github.com/libsdl-org/sdlwiki.git ~/Projects/com.github.libsdl-org.sdlwiki/libsdl-org >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/linuxy/coyote-ecs.git ~/Projects/com.github.linuxy.coyote-ecs/coyote-ecs >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/Not-Nik/raylib-zig.git ~/Projects/com.github.Not-Nik.raylib-zig/raylib-zig >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/prime31/zig-ecs.git ~/Projects/com.github.prime31.zig-ecs/zig-ecs >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/pwbh/SDL.git ~/Projects/com.github.pwbh.SDL/SDL >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/raysan5/raylib.git ~/Projects/ocm.github.raysan5.raylib/raylib >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/SanderMertens/flecs.git ~/Projects/com.github.SanderMertens.flecs/flecs >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/zig-gamedev/zflecs.git ~/Projects/com.github.zig-gamedev.zflecs/zflecs >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
git clone https://github.com/zig-gamedev/zig-gamedev.git ~/Projects/com.github.zig-gamedev.zig-gamedev/zig-gamedev >/dev/null 2>&1
[ $? -eq 128 ] && printf "."
